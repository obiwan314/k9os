...
class K9Service(rpyc.Service):
    ...
    def exposed_go_forward(self, *args, **kws):
        arduino_manager.go_forward(arduino_manager.SPEED_FASTER)
    def exposed_go_backward(self, *args, **kws):
        arduino_manager.go_backward(arduino_manager.SPEED_FASTER)
    ...
    def exposed_get_last_heading (self, *args, **kws):
        return arduino_manager.get_last_heading()
    def exposed_get_last_range (self, *args, **kws):
        return arduino_manager.get_last_range()
